...
class CNN(nn.Module):
    def __init__(self, output_dim, embedding_dim):
        ...
        self.conv1 = nn.Sequential(nn.Conv1d(4, 32, 7, stride=2, padding=3), nn.BatchNorm1d(32), nn.LeakyReLU())
        ...
        self.fc1 = nn.Sequential(nn.Linear(320, 128), nn.Dropout())
        self.fc2 = nn.Sequential(nn.Linear(128, 64), nn.Dropout())
